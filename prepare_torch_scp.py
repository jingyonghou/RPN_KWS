...
if __name__=="__main__":
    ...
    for utt_id in feats_keys:
        keyword_type = utt_id.strip().split("_")[-1]
        ...
        elif keyword_type == "freetext" and int(lens_scp_dict[utt_id]) < max_lens:
            feats_labels_scp_dict[utt_id] = feats_scp_dict[utt_id] + " 0,-1,-1"
        elif keyword_type == "0" and int(lens_scp_dict[utt_id]) < max_lens:
            feats_labels_scp_dict[utt_id] = feats_scp_dict[utt_id] + " 0,-1,-1"
        else:
            num_remove+=1
